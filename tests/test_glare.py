...
def compare_with_expected_file(
    ...
    actual_file_path = test_directory_path / "actual_output/202" / file_name
    expected_file_path = test_directory_path / "expected_output/202" / file_name
...
class TestFener:
    class TestIntegration:
        ...
        def clean_up(
            ...
            actual_output_path = test_directory_path / "actual_output/202"
        ...
        def test_simple(
            ...
            run(
                f"python3 ./src/fener.py {test_directory_path}/202.fnr -c 30 -glare")
